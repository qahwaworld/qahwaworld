...
/**
 * Generate metadata for the Russian contact page using WordPress SEO data
 */
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoData = await getCachedSeoData('ru', contactPageId);
  
  // Default values
  const defaultTitle = 'Связаться с нами - Qahwa World';
  const defaultDescription = 'Свяжитесь с Qahwa World. Обратитесь к нам с вопросами, отзывами или чтобы узнать больше о наших новостях и историях о кофе.';
  ...
  const canonical = seoData?.canonical || `${siteUrl}/ru/contact`;
