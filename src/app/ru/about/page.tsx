...
/**
 * Generate metadata for the Russian about page using WordPress SEO data
 */
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoData = await getCachedSeoData('ru', aboutPageId);
  
  // Default values
  const defaultTitle = 'О нас - Мир кофе';
  const defaultDescription = 'Узнайте о Мире кофе, нашей миссии, видении и ценностях. Откройте для себя нашу приверженность предоставлению последних новостей о кофе и историй со всего мира.';
  ...
  const keywords = seoData?.metaKeywords || 'о нас, кофе, мир кофе, миссия, видение, ценности';
  const canonical = normalizeUrl(seoData?.canonical) || `${siteUrl}/ru/about`;
