...
/**
 * Generate metadata for the privacy page using WordPress SEO data
 */
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seoData = await getCachedSeoData('en', privacyPageId);
  
  // Default values
  const defaultTitle = 'Privacy Policy - Qahwa World';
  const defaultDescription = 'Read Qahwa World\'s privacy policy to understand how we collect, use, and protect your personal information.';
  ...
  const keywords = seoData?.metaKeywords || 'privacy policy, data protection, personal information, cookies';
  const canonical = normalizeUrl(seoData?.canonical) || `${siteUrl}/privacy`;
